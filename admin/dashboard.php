        ...
        <div class="col-sm-6 col-md-4 col-lg-2">
            ...
            <div class="d-flex flex-column text-bg-dark p-3 sidebarre">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="?article_php" class="nav-link text-light">Article</a>
                    </li>
                    <li>
                        <a href="?maillot_php" class="nav-link text-light">Maillot</a>
                    </li>
                    <li>
                        <a href="?joueur_php" class="nav-link text-light">Joueur</a>
                    </li>
                    <li>
        ...
        ?>
            ...
            */
            ...
            if ( !empty( $_GET ) ) {   //si ma variable $_GET n'est pas vide, cela veut dire que j'ai cliqué sur un lien de la sidebar ( l'indice de la variable $_GET change selon le lien indiqué dans la balise a)
                ...
                if ( isset( $_GET['article_php'] ) ){
                    require_once "article.php";

                }else if (isset($_GET['showJoueur_php'])){
                    require_once "joueur.php";

                }else if (isset($_GET['users_php'])){
                    require_once "users.php";
                }else if (isset($_GET['produit_php'])){
                    require_once "maillot.php";    
                }else{
